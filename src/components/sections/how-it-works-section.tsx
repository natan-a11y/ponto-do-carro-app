            ...
            <div className="animate-in fade-in slide-in-from-left-8 duration-1000 ease-in-out">
                 <div className="mb-8">
                    ...
                    <p className="mt-4 text-lg text-muted-foreground">
                        Na Ponto do Carro, transformamos a complexa tarefa de vender seu veículo em uma experiência ágil e surpreendentemente simples. Nosso processo foi desenhado para maximizar seu tempo e seu retorno financeiro.
                    </p>
                </div>
